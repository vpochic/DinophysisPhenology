###### GAM for Dinophysis phenology with mgcv - unified ###
## V. POCHIC
# 2024-04-18
...
# write.csv2(pred_plot, 'pred_plot_20240418.csv', row.names = FALSE,
#            fileEncoding = "ISO-8859-1")
...
# Saving plot
# ggsave('gam_Dino_allsites_crop.tiff', dpi = 300, height = 175, width = 250,
#        units = 'mm', compression = 'lzw')
