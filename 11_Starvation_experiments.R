...
## Description:
# In this script we analyse and plot data from 2 starvation experiments performed
# on Dinophysis acuminata cultures in 2016 and 2024 in the PHYTOX lab (IFREMER
# Nantes, France)

## Files required:
# Data/Starvation_Experiment/2016/Cell_counts_starv_exp_2016.csv
# Data/Starvation_Experiment/2024/Cell_counts_dinophysis_starvation_2024.csv
## --> Cell counts data from culture monitoring during 2 starvation experiments
## on Dinophysis conducted in 2016 (by Thomas Lacour) and 2024
...
# 2016 experiment
Exp_data_2016  <- read.csv2('Data/Starvation_Experiment/2016/Cell_counts_starv_exp_2016.csv',
...
Exp_data_pivot <- pivot_longer(Exp_data_2016, cols = c(N1, N2, N3, NN1, NN2, NN3,
                                                  R1, R2, R3),
