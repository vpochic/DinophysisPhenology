#### Additional script: broad phenology of other phytoplankton genera ###
# Author: V. POCHIC
...
# other phytoplankton genera (Thomas' idea)
...
# Save the plot
ggsave('Plots/REPHY/Additional_plots/Barplots_4genera.tiff',
...
# Save the plot
# ggsave('Plots/REPHY/Additional_plots/Trend_plots_4genera.tiff',
#        height = 180, width = 164, units = 'mm', compression = 'lzw',
#        dpi = 500)
