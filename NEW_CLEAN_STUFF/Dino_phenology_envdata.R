...
### Import data ####
Table_hydro <- read.csv2('Data/REPHY_outputs/Table1_hydro_select_20250812.csv', 
...
# Write that down!
# write.csv2(Table_hydro_fortnightly, 'Data/REPHY_outputs/Table_hydro_fortnightly_20250812.csv',
#            row.names = FALSE, fileEncoding = "ISO-8859-1")
...
# Write that down!
# write.csv2(Table_stratif_fortnightly, 'Data/Models/GAMAR/Outputs/Table_stratif_fortnightly_20251003.csv',
#            row.names = FALSE, fileEncoding = "ISO-8859-1")
...
# Save the table
write.csv2(Table_stratif_fortnightly,
           'Data/Models/GAMAR/Outputs/Table_stratif_fortnightly.csv',
           row.names = FALSE, fileEncoding = 'ISO-8859-1')
